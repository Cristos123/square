...
import ParticipantOrganizerPage from "../../../../../components/square/participant/ShowParticipantOrganizer";
...
const Page = () => {
  ...
  const programeId = useParams();
  console.log({ programeId });
  return (
    <div className="   mt-4 md:p-8">
      {/* <AddParticipantModal
        open={newDialog}
        programeId={programeId?.programmeId}
        onClose={() => setNewDialog(false)}
      /> */}
      <ParticipantOrganizerPage programeId={programeId?.programmeId} />{" "}
