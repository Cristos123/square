...
import { Card, Container, Hidden, Switch } from "@mui/material";
...
export default function EditCahrgeModal(props) {
  ...
  return (
    <div>
      <Modal
        ...
        className="p-4  md:mx-20 my-32 justify-center overflow-y-auto"
      >
        <div className=" flex flex-col justify-center items-center bg-white p-3 md:p-6 overflow-y-auto">
          <h2 className="font-semibold py-5 text-center ">Edit Charge</h2>
          ...
          <form className="w-full " onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col   py-3">
              <p className="font-semibold text-md">Charge Calculation</p>
