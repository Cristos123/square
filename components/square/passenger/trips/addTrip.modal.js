...
export default function AddTripPassengerModal(props) {
  ...
  //       `http://localhost:3000/passenger-trips`,
  //       json,
  //       {
  //         headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const json = JSON.stringify(passengerTrip);
    try {
      toast("Please wait...");
      console.log(json);

      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_ENDPOINT}passenger-trips`,
        json,
        {
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        <Box sx={style}>
          <div className=" flex justify-center items-center bg-white p-6 overflow-y-auto">
            ...
            >
              ...
              <h2 className="font-semibold py-5 text-center ">Create A Trip</h2>
              ...
              <div className="flex w-full mb-4">
                <input
                  ...
                  value={passengerTrip?.schedule_date}
                ...
                <input
                  ...
                  value={passengerTrip?.schedule_time}
                  onChange={handleChange}
                />
              </div>{" "}
              <div className=" mt-4">
              ...
              <div className="flex w-full mb-4">
                <input
                  ...
                  type={"text"}
                  name="route_from"
                  value={passengerTrip?.route_from}
                  onChange={handleChange}
                  required
                />
                <input
