...
export default function EditOrganizerModal(props) {
  ...
  }, [organizer, organizerId, props.open]);
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    delete organizer.id;
    delete organizer.created_at;
    delete organizer.updated_at;
    ...
    try {
      ...
      const response = await axios.patch(
        `${process.env.NEXT_PUBLIC_ENDPOINT}organizer/${organizerId}`,
        json,
        {
          headers: {
