...
export default function EditDeliveryFeeModal(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(
                `https://audstacknga.herokuapp.com/api/v1/store/pricing/${props.type == "lga" ? "local" : "" || props.type == "state" ? "state" : "" || props.type == "country" ? "interstate" : "" || props.type == "global" ? "internacional" : ""}/${pricing?._id}`,
                json,
                {
                    headers: {
