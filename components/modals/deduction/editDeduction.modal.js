...
import { paymentStructure, prirority, staff } from "./addDeduction.modal";
...
export default function EditDeductionModal(props) {
    ...
    <div>
      ...
      >
        <div className=" flex flex-col justify-center items-center bg-white p-6 overflow-y-auto">
          <h2 className="font-semibold py-5 text-center ">Edit Deductions</h2>
          <form className="w-full " onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  md:gap-10">
              ...
              <InputSelect
                type="select"
                name="permanent_structure"
                label="Permanent Structure"
                placeholder="select permanent structure"
                options={paymentStructure}
                control={control}
                rules={{
                  required: "Please select permanent structure ",
                }}
                errors={errors.permanent_structure}
              />
            </div>{" "}
            <div className="grid grid-cols-1 md:grid-cols-2  md:gap-10">
              <InputSelect
